...
This private Flous Flow repository packages the OCA ``auditlog`` module for
Flous Flow's Odoo 19 deployments. The technical module name remains
``auditlog`` so existing installations and upgrade paths stay compatible.

Flous Flow
----------

* Website: https://flousflow.com
* GitHub: https://github.com/FlousFlow
* LinkedIn: https://www.linkedin.com/company/flous-flow/

This repository contains integration and packaging metadata for Flous Flow;
the original OCA copyright notices and AGPL-3 licensing terms remain in force.
Do not remove the OCA attribution when redistributing the module.
...
..
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:3db0314c73f17e5c63ecb5205a4d29beff97812aca664e1dd624646702f14bee
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
